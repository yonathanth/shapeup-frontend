    ...
    >
      ...
      <div className="flex flex-col justify-between h-full">
        ...
        <div className="flex items-center justify-between md:-mt-4 sm:-mt-12 lg:hidden">
          <p className="text-customBlue font-bold">ETB {price.toFixed(2)}</p>
          <button
        ...
        <button
          onClick={handleAddToCart}
          className="hidden lg:flex items-center justify-center w-auto border border-customBlue text-customBlue py-2 px-4 rounded-full hover:bg-customBlue hover:text-black mt-2 transition"
        >
          Add to Cart
        </button>
      </div>
