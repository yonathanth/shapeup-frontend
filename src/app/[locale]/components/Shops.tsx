      ...
      <div className="flex flex-col md:flex-row md:space-x-16 justify-center">
        ...
        <div className="flex flex-col justify-between mb-8 md:mb-0">
          <div className="container mx-auto">
            ...
            <Link href="/Shop">
              <h2 className="text-6xl font-bold mb-4 text-[#871818]">
            ...
            <div>
              ...
              <div className="absolute bottom-4 left-4 flex justify-between items-center w-[95%]">
                <div className="flex items-baseline space-x-1">
                  ...
                  {/* Use translated CTA button */}
                </div>
                <span className="button-custom text-sm text-[#871818] border border-solid border-[#871818] rounded-md px-3 py-1">
                  {t("products.0.ctaButton")}
                </span>
              </div>
            </div>
        ...
        <div className="flex flex-col justify-between">
          ...
          <div className="flex justify-between mt-4">
            <p className="text-2xl text-white">{t("products.1.badge")}</p>{" "}
            {/* Use translated badge */}
            <p className="text-sm text-gray-400 font-thin">
              {t("products.1.discountText")}{" "}
              {/* Use translated discount text */}
            </p>
          </div>
        </div>
      </div>
